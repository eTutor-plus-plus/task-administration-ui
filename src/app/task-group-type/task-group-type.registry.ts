...
import { TaskGroupTypeDroolsComponent } from './task-group-type-drools/task-group-type-drools.component';
...
export class TaskGroupTypeRegistry {
  ...
  private static readonly taskTypes: { name: string, component?: Type<TaskGroupTypeFormComponent<any>>, supportsDescriptionGeneration?: boolean }[] = [
    ...
    {name: 'drools', component: TaskGroupTypeDroolsComponent, supportsDescriptionGeneration: true},
  ];
