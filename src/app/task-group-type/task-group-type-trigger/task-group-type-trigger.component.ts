...
/**
 * Task Group Type Form: Trigger
 */
@Component({
  selector: 'dke-task-group-type-trigger',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    TranslocoDirective,
  ...
  templateUrl: './task-group-type-trigger.component.html',
  styleUrl: './task-group-type-trigger.component.scss'
})
export class TaskGroupTypeTriggerComponent extends TaskGroupTypeFormComponent<TaskGroupTypeForm> {
