...
export class TaskTypeCypherComponent extends TaskTypeFormComponent<TaskTypeForm> implements OnChanges, OnDestroy {

  private sub?: Subscription;

  /**
   * Creates a new instance of class TaskTypeCypherComponent.
   */
  ...
  private async updateValidator(taskGroupId: number | null): Promise<void> {
    ...
    try {
      ...
      if (!tg.additionalData || tg.dto.taskGroupType !== 'cypher')
        return;
